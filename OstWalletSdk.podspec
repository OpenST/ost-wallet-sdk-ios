#
#  Be sure to run `pod spec lint OstWalletSdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.license      = { :type => "The Apache Software License, Version 2.0", :file => "LICENSE.md" }
  ...
  spec.author             = { "Ost" => "ios.publisher@ost.com" }
  # Or just: spec.author    = "Deepesh Kumar Nath"
  # spec.authors            = { "Deepesh Kumar Nath" => "deepesh@ost.com" }
  # spec.social_media_url   = "https://twitter.com/Deepesh Kumar Nath"
