...
class BaseModel {
    ...
    //Use this while creating build.
//    static let MAPPY_APP_SERVER_URL = "https://s7-mappy.stagingost.com/api";
//    static let KIT_API_ENDPOINT = "https://s7-api.stagingost.com/testnet/v2";
