...
class OstExecuteTransaction: OstWorkflowEngine, OstDataDefinitionWorkflow {
	...
	static let REDEMPTION_META = "redemption_meta"
	...
	private let redemptionMeta: [String: Any]?
    ...
    init(userId: String,
		...
		self.redemptionMeta = options[OstExecuteTransaction.REDEMPTION_META] as? [String: Any];
    ...
    private func executeTransaction() {
        do {
			...
			if (nil != self.redemptionMeta) {
				params["redemption_meta"] = self.redemptionMeta
			}
    ...
    override func getWorkflowContext() -> OstWorkflowContext {
        return OstWorkflowContext(workflowId: self.workflowId, workflowType: .executeTransaction)
    }
