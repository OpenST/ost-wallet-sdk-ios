...
//    }
    ...
    func subscribe(forWorkflowId workflowId: String, listner: OstWorkflowUIDelegate) {
    ...
    func unsubscribe(forWorkflowId workflowId: String, listner: OstWorkflowUIDelegate) {
