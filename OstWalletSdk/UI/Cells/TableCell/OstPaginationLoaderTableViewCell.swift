...
class OstPaginationLoaderTableViewCell: OstBaseTableViewCell {

    static var paginationCellIdentifier: String {
        return String(describing: OstPaginationLoaderTableViewCell.self)
    }
