...
public enum OstErrorText: String {
    ...
    case deviceNotAuthorized = "Unable to perform the operation as the device is not unauthorized. For details on how to authorize a device please visit https://dev.ost.com/platform/docs/sdk"
    ...
    case deviceAlreadyAuthorized = "This Device is already authorized."
    ...
    case entityNotAvailable = "Unable to recognize the API request object sent and so cannot be executed."
    case unknownEntity = "Unable to recognize the API request object sent and so cannot be executed."
    case invalidAPIResponse = "Unable to recognize the API request object sent and so cannot be executed."
    ...
    case invalidTokenId = "Unable to recognize the user id. Please inspect for what is being sent, rectify and re-submit."
    ...
    case failedWithMaxRetryCount = "The maximum number of 'authenticating with PIN' attempts has been reached. Please try again a bit later."
    ...
    case invalidRuleName = "Unable to recognize the Rule Name. Please inspect a valid rule name is passed. Ensure its not null and re-submit the request. Visit https://dev.ost.com/platform to know about rule details"
