...
public enum OstErrorText: String {
    ...
    case invalidAmount = "Amount to do transaction is invalid. Please inspect the amount is not null and is a valid atto brand token value. Visit https://dev.ost.com/platform to know about brand token to atto brand token conversion."
    ...
    case invalidSpendingLimit = "Spending limit provided is invalid. Spending limit is in atto OST and can not be decimal value. Please inspect the value being sent is correct and not null, rectify and re-submit."
